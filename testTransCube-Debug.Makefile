...
_ECSOURCES = \
	form1.ec \
	$(ECERE_SDK_SRC)/ide/src/designer/SyntaxColorScheme.ec \
	$(ECERE_SDK_SRC)/ide/src/designer/SyntaxHighlighting.ec
...
$(OBJ)SyntaxColorScheme.sym: $(ECERE_SDK_SRC)/ide/src/designer/SyntaxColorScheme.ec
	$(ECP) $(CFLAGS) $(CECFLAGS) $(ECFLAGS) $(PRJ_CFLAGS) -c $(call quote_path,$(ECERE_SDK_SRC)/ide/src/designer/SyntaxColorScheme.ec) -o $(call quote_path,$@)

$(OBJ)SyntaxHighlighting.sym: $(ECERE_SDK_SRC)/ide/src/designer/SyntaxHighlighting.ec
	$(ECP) $(CFLAGS) $(CECFLAGS) $(ECFLAGS) $(PRJ_CFLAGS) -c $(call quote_path,$(ECERE_SDK_SRC)/ide/src/designer/SyntaxHighlighting.ec) -o $(call quote_path,$@)
...
$(OBJ)SyntaxColorScheme.c: $(ECERE_SDK_SRC)/ide/src/designer/SyntaxColorScheme.ec $(OBJ)SyntaxColorScheme.sym | $(SYMBOLS)
	$(ECC) $(CFLAGS) $(CECFLAGS) $(ECFLAGS) $(PRJ_CFLAGS) $(FVISIBILITY) -c $(call quote_path,$(ECERE_SDK_SRC)/ide/src/designer/SyntaxColorScheme.ec) -o $(call quote_path,$@) -symbols $(OBJ)

$(OBJ)SyntaxHighlighting.c: $(ECERE_SDK_SRC)/ide/src/designer/SyntaxHighlighting.ec $(OBJ)SyntaxHighlighting.sym | $(SYMBOLS)
	$(ECC) $(CFLAGS) $(CECFLAGS) $(ECFLAGS) $(PRJ_CFLAGS) $(FVISIBILITY) -c $(call quote_path,$(ECERE_SDK_SRC)/ide/src/designer/SyntaxHighlighting.ec) -o $(call quote_path,$@) -symbols $(OBJ)
...
$(OBJ)SyntaxColorScheme$(O): $(OBJ)SyntaxColorScheme.c
	$(CC) $(CFLAGS) $(PRJ_CFLAGS) $(FVISIBILITY) -c $(call quote_path,$(OBJ)SyntaxColorScheme.c) -o $(call quote_path,$@)

$(OBJ)SyntaxHighlighting$(O): $(OBJ)SyntaxHighlighting.c
	$(CC) $(CFLAGS) $(PRJ_CFLAGS) $(FVISIBILITY) -c $(call quote_path,$(OBJ)SyntaxHighlighting.c) -o $(call quote_path,$@)
