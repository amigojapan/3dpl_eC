...
class ModelViewer : Window
{
   ...
   Button btnRun
   {
      ...
      {
         String code = editBoxDeclarations.multiLineContents;
         String result = executeDeclarations(code);
...
*/
   ...
   {
      this, caption = $"Code Editor", opacity = 0.3f, lightGreen, font = { "DejaVu Sans Mono", 20 }, size = { 500, 500 }, position = { 32, 200 }, hasVertScroll = true, displayDriver = "OpenGL", multiLine = true, contents = "for(var i=-3;i<3;i++) {\n   qb(\"a\",i,i,i);\n"
   "}\n"
